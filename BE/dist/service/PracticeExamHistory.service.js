...
class PracticeExamHistoryService {
    getExamByUserId(_a) {
        return __awaiter(this, arguments, void 0, function* ({ userId }) {
            ...
            const examHistory = yield PracticeExamHistory_1.default.find({
                userId: userIdObjectId,
            })
                .sort({
                createdAt: -1,
            })
                .select("-__v -updatedAt -_id -completedAt -selectedQuestions -userAnswers")
                .lean();
            return examHistory;
        });
    }
}
exports.default = new PracticeExamHistoryService();
